            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="/user/create"  class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 添加</a>
                ...
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="am-hide-sm-only"><img src="{{$v['upic']}}" width="50" alt=""></td>
                            <td class="am-hide-sm-only">{{$v['score']}}</td>
                            <td class="am-hide-sm-only">{{$v['status']}}</td>
                            <td class="am-hide-sm-only">{{$v['uaddr']}}</td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="/user/{{$v['id']}}/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
