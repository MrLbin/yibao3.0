...
<link rel="stylesheet" type="text/css" href="/homes/css/lunbo.css">
<script src="/homes/js/jquery-1.8.3.min.js"></script>

<script src="/homes/js/public.js"></script>
</head>
<body>
<!--顶部菜单-->
<div class="dy1">
	<div class="dy2">
        <ul class="dy3">
            <li><a href="#">易宝官网<br/>购物无忧</a></li>
            <li><a href="#" id="diyunapp">商城APP<br/>商城APP</a></li>
        </ul>
        <a href="#" class="dy5">购物车</a>
        <ul class="dy4">
            <li><a href="/grzx">个人中心<br/>个人中心</a></li>
            <li><a href="/home/login">登录<br/>登录</a></li>
            <li><a href="/register/create">注册<br/>注册</a></li>
        </ul>
        <div class="dy6">
            <ul>
               	<li>
                   	<b><img src="/homes/img/wxrzhuji.jpg"/></b>
                    <a href="#" class="dy7">外星人主机</a>
                    <a href="#" class="dy8">删除</a>
                </li>
                <li>
                   	<b><img src="/homes/img/gaoqingxianshiqi.jpg"/></b>
         ...
         <div class="dy9">
         	<img src="/homes/img/phone.png" style="width:100px;">
         </div>
    </div>
</div>
<!--logo加时间加搜索框-->
<div class="dy10">
	<div class="dy11">
    	<img src="/homes/img/logo.png" width="80">
    </div>
    <div class="dy13">
    	<embed src="/homes/img/honehone_clock_wh.swf" style=" height:45px; width:120px"></embed>
    </div>
    <div class="dy12">
...
<!--banner轮播引入lunbo.css和daohang.js-->
 ...
 <div id="big_banner_wrap" style="display:block">
		 ...
		 <li class="active"img>
			 ...
			 <div class="banner_menu_content" style="width: 600px; top: -20px;">
				 <ul class="banner_menu_content_ul">
					 <li>
						 <a><img src="/homes/img/headphone.jpg"></a><a>乐乐耳机</a><span>选购</span></li>
					 <li>
						 <a><img src="/homes/img/headphone.jpg"></a><a>乐乐耳机</a><span>选购</span></li>
					 <li>
						 <a><img src="/homes/img/headphone.jpg"></a><a>乐乐耳机</a><span>选购</span></li>
	 ...
	 <div id="big_banner_pic_wrap">
		 <ul id="big_banner_pic">
			 <li><img src="/homes/img/T1hiDvBvVv1RXrhCrK.jpg"></li>
			 <li><img src="/homes/img/T1jrxjB_VT1RXrhCrK.jpg"></li>
			 <li><img src="/homes/img/T1oTJjBKKT1RXrhCrK.jpg"></li>
			 <li><img src="/homes/img/T1RICjB7DT1RXrhCrK.jpg"></li>
			 <li><img src="/homes/img/T1vWdTBKDv1RXrhCrK.jpg"></li>
		 </ul>
	 </div>
 ...
 <script src="/homes/js/daohang.js"></script>
<!--乐乐周边啊-->
<div class="dy14">
 	<div class="dy15">
    	<ul>
   	...
   	<div class="dy16">
    	<ul>
        	<li><a href="#"><img src="/homes/img/jinghuaqi.jpg"/></a></li>
            <li><a href="#"><img src="/homes/img/jinghuaqi1.jpg"/></a></li>
            <li><a href="#"><img src="/homes/img/jinghuaqi2.jpg"/></a></li>
        </ul>
    </div>
</div>
<!--一个推荐商品的轮播-->
...
<div class="lunbobanner">
	<ul class="lunboimg">
    	<li>
        	<a href="#">
            	<b><img src="/homes/img/diannaozhuji.png"/></b>
                    <h5>磐石DIY游戏主机</h5>
                    <p>坚如磐石，带给你极致游戏体验</p>
                    <span>5000元5</span>
            </a>
...
<div class="dy17">
	...
	<div class="dy18" id="fzxba">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576c00e9N4c11aa86.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="ghmza">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/5768218bNb97302b8.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="sjtxa">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576cab8fN177984a7.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="jydqa">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576dd6feN49b56802.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="dnsma">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576ce73fN0668b963.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="ydjsa">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576c011eN94af6880.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="jjsha">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576c0146Nd76b5b84.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="mywja">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/57688f2fNd2a525ed.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="spbja">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576ca30fNb5eb8da6.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="tsyxa">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/5767a886N9d35e524.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
    ...
    <div class="dy18" id="zcypa">
        ...
        <div class="dy21">
        	<div class="dy22">
            	<div class="dy24"><a href="#"><img src="/homes/img/576c016dN53e629e1.jpg"/></a></div>
                <div class="dy25">
                	<ul>
                    	<li><a href="#">空调</a></li>
                        <li><a href="#">冰箱</a></li>
...
<div class="footer">
	<div class="box" style=" width:1226px; margin:0 auto">
        <ul class="lian">
            <li>
                <p><img src="/homes/img/fot.png">新手指南</p>
                <a href="#">账户注册</a>
                <a href="#">购物流程</a>
                <a href="#">网站地图</a>
            </li>
            <li>
                <p><img src="/homes/img/fot1.png">支付方式</p>
                <a href="#">货到付款</a>
                <a href="#">在线支付</a>
                <a href="#">礼品卡及账户余额</a>
                <a href="#">其他支付方式</a>
            ...
            <li>
                <p><img src="/homes/img/fot2.png">配送说明</p>
                <a href="#">配送运费</a>
                <a href="#">配送时间</a>
            </li>
            <li>
                <p><img src="/homes/img/fot3.png">售后服务</p>
                <a href="#">退换货政策</a>
                <a href="#">退换货办理流程</a>
                <a href="#">退换货网上办理</a>
                <a href="#">退款说明</a>
            ...
            <li>
                <p><img src="/homes/img/fot4.png">关于我们</p>
                <a href="#">公司简介</a>
                <a href="#">合作专区</a>
                <a href="#">联系我们</a>
                <a href="#">友情链接</a>
            ...
            <li>
                <p><img src="/homes/img/fot5.png">帮助中心</p>
                <a href="#">找回密码</a>
                <a href="#">邮件订阅</a>
                <a href="#">产品册订阅</a>
                <a href="#">隐私声明</a>
        ...
        <ul class="adv">
        	<li><img src="/homes/img/adv.png">正品保障</li>
            <li><img src="/homes/img/adv1.png">免运费</li>
            <li><img src="/homes/img/adv2.png">送货上门</li>
            <li style="border-right:none;"><img src="/homes/img/adv3.png">实物拍摄</li>
        </ul>
