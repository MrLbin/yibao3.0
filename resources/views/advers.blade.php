            ...
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" method="post" action="/user">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="data_max" class="tpl-form-input" id="user-name" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label for="user-name" class="am-u-sm-3 am-form-label">有效时间 <span class="tpl-form-line-small-title"></span></label>
                        <div class="am-u-sm-9">
                            <input type="text" name="data_min" class="tpl-form-input" id="user-name" placeholder="">
                        </div>
                    </div>
